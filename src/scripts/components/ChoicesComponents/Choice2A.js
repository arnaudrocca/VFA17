			...
			<div className="choice__interaction-container">
				...
				<div className="choice__interaction-main">
					<div className="building">
						<p className="building__name js-building__name">Église</p>
						<p className="building__name js-building__name">Marché</p>
						<div className="choice__interaction-main--root" ref="root"></div>
						<button onClick={this.handleSubmit.bind(this)} className="choice__main-btn choice__main-btn--validate choice__main-btn--2A js-btn--validate--2A" type="button">
							<span>Valider</span>
