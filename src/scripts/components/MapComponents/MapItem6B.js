		...
		return (
			<div className="mapItemContainer">
				...
				<div className="mapItem__turbine__container mapItem__turbine__container-0">
					<img className="mapItem mapItem__turbine mapItem__turbine-0" src="assets/images/mapAnimations/turbine.svg"/>
				</div>
				<div className="mapItem__turbine__container mapItem__turbine__container-1">
					<img className="mapItem mapItem__turbine mapItem__turbine-1" src="assets/images/mapAnimations/turbine.svg"/>
				</div>
				<div className="mapItem__turbine__container mapItem__turbine__container-2">
					<img className="mapItem mapItem__turbine mapItem__turbine-2" src="assets/images/mapAnimations/turbine.svg"/>
				</div>
				<div className="mapItem__turbine__container mapItem__turbine__container-3">
					<img className="mapItem mapItem__turbine mapItem__turbine-3" src="assets/images/mapAnimations/turbine.svg"/>
				</div>
			</div>
		)
